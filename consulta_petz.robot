...
Consulta Produto Com clique na Lupa
    ...
    Qando escrevo "Ração" na barra de pesquisa
    E clico no botão da lupa
    Então exibe um grid e a frase do resultado esperado

Consulta Produto Apertando Enter
    [Tags]    rapido
    Dado que acesso o site como cliente
    Qando escrevo "Coleira" na barra de pesquisa
...
Compra de Produto
    ...
    Qando escrevo "Pote" na barra de pesquisa
    E aperto a tecla Enter
    Então exibe um grid e a frase do resultado esperado
...
Qando escrevo "${palavra_chave}" na barra de pesquisa
...
Então exibe a pagina do carrinho com o total de "${preco_total}"
    ...
    #wait until element is visible visible           xpath = //div[@id="cart-item-147547"]
